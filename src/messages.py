...
_MESSAGES = {
    ...
    "help_text": {
        "ko": (
            ...
            "  /sys \u2014 시스템 (CPU/RAM)\n"
            "  /log (/l) [N] \u2014 로그\n"
            "  /mode [minimal/normal] \u2014 출력 모드\n\n"
            "\U0001f504 세션 관리\n"
            "  /esc (/interrupt) <name> \u2014 작업 중단\n"
            "  /pause (/p) <name> \u2014 일시정지\n"
            "  /restart (/r) <name> \u2014 재시작\n"
            "  /reset <name> \u2014 리셋\n"
            "  /ask <질문> \u2014 Claude 질문\n\n"
            "\U0001f916 Claude Code\n"
            "  /로 시작하는 기타 명령은 세션에 직접 전달\n"
            "  예: /compact, /context, /cost, /review ...\n\n"
            "  /help (/h) \u2014 이 목록\n"
            "세션: {names}"
        ),
        "en": (
            ...
            "  /sys \u2014 system (CPU/RAM)\n"
            "  /log (/l) [N] \u2014 logs\n"
            "  /mode [minimal/normal] \u2014 output mode\n\n"
            "\U0001f504 Session\n"
            "  /esc (/interrupt) <name> \u2014 interrupt\n"
            "  /pause (/p) <name> \u2014 pause\n"
            "  /restart (/r) <name> \u2014 restart\n"
            "  /reset <name> \u2014 reset\n"
            "  /ask <question> \u2014 ask Claude\n\n"
            "\U0001f916 Claude Code\n"
            "  Other / commands are passed directly to the session\n"
            "  e.g. /compact, /context, /cost, /review ...\n\n"
            "  /help (/h) \u2014 this list\n"
            "Sessions: {names}"
        ),
    },
